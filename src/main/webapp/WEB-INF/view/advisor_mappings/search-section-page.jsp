...
--%>
		...
		<div class="container">
		  <br />
		  <h2 class="text-center">Search For Section</h2>

<form:form action="${pageContext.request.contextPath}/advisor/sectionbyName" method="get">

    	<p>Enter Section Name</p>
        <input type="text" placeholder="Search Using Section Name" name="name" class="form-control">
        <br/>
