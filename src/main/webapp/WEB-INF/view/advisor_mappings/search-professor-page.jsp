...
--%>
		...
		<div class="container">
		  <br />
		  <h2 class="text-center">Search For Professors</h2>

<form:form action="${pageContext.request.contextPath}/advisor/professorbyName" method="get">

    	<p>Enter Section Name</p>
        <input type="text" placeholder="Search Using Professor Name" name="name" class="form-control">
        <br/>
