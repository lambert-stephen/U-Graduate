...
--%>
		...
		<div class="container">
		  <br />
		  <h2 class="text-center">Search For Major</h2>

<form:form action="${pageContext.request.contextPath}/advisor/majorbyName" method="get">

    	<p>Enter Major Id</p>
        <input type="text" placeholder="Search Using Major Id" name="id" class="form-control">
        <br/>
